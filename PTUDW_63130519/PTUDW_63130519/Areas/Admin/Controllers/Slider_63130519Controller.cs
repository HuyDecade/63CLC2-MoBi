...
{
    public class Slider_63130519Controller : Controller
    {
        ...
        public ActionResult Create(Sliders_63130519 sliders)
        {
        ...
        public ActionResult Status(int? id)
        {
            ...
            Sliders_63130519 sliders = slidersDAO.getRow(id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Sliders_63130519 sliders)
        {
            if (ModelState.IsValid)
            {
                //Xu ly cho muc Slug
