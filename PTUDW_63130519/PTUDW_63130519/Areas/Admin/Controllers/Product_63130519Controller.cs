...
{
    public class Product_63130519Controller : Controller
    {
        ...
        public ActionResult Create(Products_63130519 products)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Products_63130519 products)
        {
            if (ModelState.IsValid)
            {
                ...
                Links_63130519 links = linksDAO.getRow(products.Id, "product");
