...
{
    public class Topic_63130519Controller : Controller
    {
        ...
        public ActionResult Create(Topics_63130519 topics)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Topics_63130519 topics)
        {
            if (ModelState.IsValid)
            {
                //Xu ly tu dong: Slug
                ...
                Links_63130519 links = linksDAO.getRow(topics.Id, "topic");
