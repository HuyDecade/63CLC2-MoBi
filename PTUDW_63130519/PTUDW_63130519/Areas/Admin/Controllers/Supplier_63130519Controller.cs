...
{
    public class Supplier_63130519Controller : Controller
    {
        ...
        public ActionResult Create(Suppliers_63130519 suppliers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Suppliers_63130519 suppliers)
        {
            if (ModelState.IsValid)
            {
                ...
                Links_63130519 links = linksDAO.getRow(suppliers.Id, "supplier");
