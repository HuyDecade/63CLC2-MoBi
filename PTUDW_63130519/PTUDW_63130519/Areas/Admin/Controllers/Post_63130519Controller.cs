...
namespace PTUDW_63130519.Areas.Admin.Controllers
{
    public class Post_63130519Controller : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            {
                //Thong bao that bai
                TempData["message"] = new XMessage("danger", "Không tồn tại bài viết");
                return RedirectToAction("Index");
            }
            Posts_63130519 posts = postsDAO.getRow(id);
            if (posts == null)
            {
                //Thong bao that bai
                TempData["message"] = new XMessage("danger", "Không tồn tại bài viết");
        ...
        public ActionResult Create(Posts_63130519 posts)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    Links_63130519 links = new Links_63130519();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Posts_63130519 posts)
        {
            if (ModelState.IsValid)
            {
                //Xu ly cho muc Slug
        ...
        public ActionResult Delete(int? id)
        {
            ...
            Posts_63130519 posts = new Posts_63130519();
            if (posts == null)
            {
                //Thong bao that bai
                TempData["message"] = new XMessage("danger", "Xóa mẫu tin thất bại");
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            {
                Links_63130519 links = linksDAO.getRow(posts.Id, "post");
                //Xoa luon cho Links
        ...
        public ActionResult DelTrash(int? id)
        {
            ...
            else
            {
                ...
                //Thong bao cap nhat trang thai thanh cong
                TempData["message"] = TempData["message"] = new XMessage("success", "Xóa bài viết thành công");
