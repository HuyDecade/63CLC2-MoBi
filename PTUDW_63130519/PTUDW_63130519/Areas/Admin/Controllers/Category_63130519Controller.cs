    ...
    {
        public class Category_63130519Controller : Controller
        {
            ...
            public ActionResult Create(Categories_63130519 categories)
            {
            ...
            [HttpPost]
            [ValidateAntiForgeryToken]
            public ActionResult Edit(Categories_63130519 categories)
            {
                if (ModelState.IsValid)
                {
                    //Xu ly tu dong: Slug
                ...
                Links_63130519 links = linksDAO.getRow(categories.Id, "category");
