...
{
    public class Module_63130519Controller : Controller
    {
        ///////////////////////////////////////////////////////////////////////////
        ...
        {
            List<Menus_63130519> list = menusDAO.getListByParentId(0, "MainMenu");
        ...
        {
            List<Menus_63130519> list = menusDAO.getListByParentId(id, "MainMenu");
        ...
        public ActionResult Slider()
        {
            ...
            List<Sliders_63130519> list = slidersDAO.getListByPosition("slider");//ten ham dat tuy y
        ...
        {
            MenusDAO menusDAO = new MenusDAO();
            List<Menus_63130519> list = menusDAO.getListByParentId(0, "Footer");
